...
class WhatsappStickersIncorrectSizeTrayImageException
    extends WhatsappStickersException {
  static const String code = 'INCORRECT_SIZE_TRAY_IMAGE';

  WhatsappStickersIncorrectSizeTrayImageException(String? cause) : super(cause);

  @override
  String toString() => 'Incorrect size';
}
